...
<footer className="container">
  <div className="row">
    <div className="col-md-4">
      <img className="footer-photo" src={pic} alt="BOC trophies" title="BOC trophies"></img>
    </div>
    <div className="col-md-8">
      ...
      <p>Copyright © 2017 <a href="https://www.maprunner.co.uk" target="_blank">Maprunner</a>.</p>
    </div>
  </div>
</footer>
</div>
